...
from dojo.human_feedback.utils import HFLConstants
from dojo.protocol import Scores
from dojo.scoring.icc import calculate_icc
...
async def _calc_tf_score(sf_task: ValidatorTask) -> dict[str, float]:
    ...
    normalized_tf_scores = _normalize_tf_scores(hotkey_to_tf_score)
