# Bittensor/blockchain specific functions
...
def get_effective_stake(hotkey: str, subtensor: bt.subtensor) -> float:
    ...
    try:
        ...
        logger.trace(
            f"Hotkey {hotkey} not found in subnet metagraph for netuid: {subnet_metagraph.netuid if subnet_metagraph else 'unknown_netuid'}, defaulting to 0 alpha_stake"
        )
